...
/**
 * * This is supposed to be used as an English (en) resource bundle in tests.
 *
 * @author StefanZ
 */
public class ResourceBundle_en extends ListResourceBundle {
    private Object[][] contents =
        {{ResourceBundleResolverTest.PROPERTY_NAME, ResourceBundleResolverTest.PROPERTY_VALUE},
            {ResourceBundleResolverTest.MISSING_PROPERTY_NAME, ResourceBundleResolverTest.MISSING_PROPERTY_VALUE}};
